...
function TiptapImage(props: NodeViewProps) {
  ...
  function handleCaptionKeyDown(e: any) {
    if (e.key === "Enter") {
      handleCaptionBlur();
    }
  }
          ...
          {editor?.isEditable && (
            <>
              <div
                ...
                onTouchStart={(event:any) => handleTouchStart(event, "left")}
              >
              ...
              <div
                ...
                onTouchStart={(event:any) => handleTouchStart(event, "right")}
              >
                <div className="z-20 h-[70px] w-1 rounded-xl border bg-[rgba(0,0,0,0.65)] opacity-0 transition-all group-hover:opacity-100" />
              </div>
            </>
          ...
          >
            ...
            <DropdownMenu open={openedMore} onOpenChange={setOpenedMore}>
              <DropdownMenuTrigger asChild>
                <Button type="button" size="icon" className="size-7" variant="ghost">
